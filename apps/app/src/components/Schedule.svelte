        ...
        {#each schedule.classes as { title, type, subtitle, time, room }, i (i)}
            <div
                class={[
                    ...
                    "grid grid-cols-[22px_1fr] gap-1.5 py-1.5 px-3 items-center",
            ...
            >
                ...
                <div class="flex items-center justify-between gap-2">
                    <div class="flex flex-col gap-1 justify-evenly h-full pl-1">
                        <Title
                            level={5}
                    ...
                    <div class="flex flex-col gap-[4px]  shadow-sm p-1 rounded-lg">
