import {
    ...
    j as is_extensible,
    E as EFFECT_RAN,
    k as EFFECT_PRESERVED,
    l as BOUNDARY_EFFECT,
    m as HEAD_EFFECT,
    n as DESTROYED,
    p as INERT,
    q as EFFECT_TRANSPARENT,
    r as STALE_REACTION,
    t as RENDER_EFFECT,
    u as EFFECT,
    v as USER_EFFECT,
    w as run_all,
    x as DISCONNECTED,
    y as EFFECT_IS_UPDATING,
    B as BROWSER,
    z as index_of,
    A as define_property,
    F as COMMENT_NODE,
    G as HYDRATION_START,
    J as HYDRATION_END,
    K as array_from,
    L as LEGACY_PROPS,
    N as render,
        ...
        if (dependencies !== null) {
            ...
            if (is_disconnected || is_unowned_connected) {
                ...
                for (i = 0; i < length; i++) {
                    ...
                    if (
                        is_disconnected ||
                        !dependency?.reactions?.includes(derived)
                    ) {
...
function update_reaction(reaction) {
    ...
    try {
        ...
        if (
            ...
            for (
                i = 0;
                i < /** @type {Source[]} */ untracked_writes.length;
                i++
            ) {
                schedule_possible_effect_self_invalidation(
                    untracked_writes[i],
...
class Svelte4Component {
    ...
    constructor(options2) {
        ...
        this.#instance = (options2.hydrate ? hydrate : mount)(
            options2.component,
            {
